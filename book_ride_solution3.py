...
auto1 = Vehicle("auto",[0,15],10,"yes")
auto2 = Vehicle("auto",[16,30],8,"yes")
auto3 = Vehicle("auto",[31,1000],15,"yes")

micro1 = Vehicle("micro",[0,15],12,"yes")
micro2 = Vehicle("micro",[16,1000],10,"yes")
micro3 = Vehicle("micro",[0,15],14,"no")
micro4 = Vehicle("micro",[16,1000],12,"no")

xl1 = Vehicle("xl",[0,15],14,"yes")
xl2 = Vehicle("xl",[16,1000],14,"yes")
xl3 = Vehicle("xl",[0,15],15,"no")
xl4 = Vehicle("xl",[16,1000],15,"no")
